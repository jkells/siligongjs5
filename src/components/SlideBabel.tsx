    ...
    return (
        <>
            ...
            <div>
                ...
                <SyntaxHighlighter language='bash' style={dark}>{babelCode}</SyntaxHighlighter>
            </div>
            <div>
                <h2>Rename to .ts/.tsx (Thanks <a href="https://stackoverflow.com/questions/21985492/recursively-change-file-extensions-in-bash">Stack Overflow</a>)</h2>
                <SyntaxHighlighter language='bash' style={dark}>{renameCode}</SyntaxHighlighter>
            </div>
            <div>
                <h2>Update extensions in webpack.conf.js</h2>
                <SyntaxHighlighter language='javascript' style={dark}>{webpackCode}</SyntaxHighlighter>
            </div>
            <div>
